                ...
                <div className='twelve columns'>
                  <div className='quote-sep'>
                    <h4>
                      ...
                      how it looks. But of course, if you dig deeper, it's
                      really how it works."
                    </h4>
          ...
          <div className='container'>
            <div className='twelve columns'>
              <div id='owl-logos' className='owl-carousel owl-theme'>
                <div className='item'>
                  <Image src='/logos/white1.png' alt='' layout='fill' />
                </div>
                <div className='item'>
                  <Image src='/logos/white2.png' alt='' layout='fill' />
                </div>
                <div className='item'>
                  <Image src='/logos/white3.png' alt='' layout='fill' />
                </div>
                <div className='item'>
                  <Image src='/logos/white4.png' alt='' layout='fill' />
                </div>
                <div className='item'>
                  <Image src='/logos/white5.png' alt='' layout='fill' />
                </div>
                <div className='item'>
                  <Image src='/logos/white6.png' alt='' layout='fill' />
                </div>
                <div className='item'>
                  <Image src='/logos/white1.png' alt='' layout='fill' />
                </div>
